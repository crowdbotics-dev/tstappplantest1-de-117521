...
## Project Structure
    ...
    ├── tstappplantest_dev_117521  # Django project configurations
...
1. Clone this repo and `cd tstappplantest_dev_117521`
...
2. Clone this repo and `cd tstappplantest_dev_117521`
